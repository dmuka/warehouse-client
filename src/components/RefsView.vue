<template>
    <div class="refs-view">
        ...
        <DataTable v-if="showArchive ? archivedItems.length > 0 : activeItems.length > 0" :value="showArchive ? archivedItems : activeItems" stripedRows showGridlines  selectionMode="single"
